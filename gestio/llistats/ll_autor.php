...
<table width="100%" >
  ...
  <tr>
    <td width="2%">&nbsp;</td>
    <td colspan="1" class="etiqueta">Autor</td>
  ...
  <tr>
    <td></td>
    <td class="<?=$class?>" colspan="1"><?= $aut->get_aut_autor()?></td>
    <td colspan="2"></td>
  ...
  <tr>  <td colspan="1"></td><td colspan="1"></td>  <td colspan="2"> <?= $llibre->get_lli_llibre();?> </td></tr>
    <?php }?> 
  <?php
    }
  ?>
